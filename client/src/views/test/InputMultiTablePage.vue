...
<template>
    <InputMultiTable title="출고정보" :defaultForm="formData" :formSchema="formSchema" :tableData="tableData" :tableHeader="tableHeader" :detailData="detailData" :detailColumns="columns" :detailCRUD="true" @onRowSelect="onRowSelect">
        <template #btn>
